...
class ImproveTipsLibrary extends React.PureComponent {
    constructor (props) {
        super(props);
        bindAll(this, [
            'handleItemSelect'
...
const mapStateToProps = state => ({
    visible: state.scratchGui.modals.improveTipsLibrary
});

const mapDispatchToProps = dispatch => ({
    onActivateDeck: id => dispatch(activateDeck(id)),
    onRequestClose: () => dispatch(closeImproveTipsLibrary())
});
