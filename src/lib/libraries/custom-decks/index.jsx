    ...
    'scratch-basics': {
        ...
        steps: [
            ...
            },
            {
                ...
                title: (
                    <div className={styles.contentContainer}>
                        <p className={styles.contentTitle}><PracticeLabel />Create Your First Scratch Program</p>
                        <ScrollableContainer height='300px'>
                            <p><StepLabel step="step 1/2" />
                                Create a sequence of blocks as shown below.
                                Click the block sequence for the Cat to perform the corresponding actions.
                                <img src={stepMove} className={styles.contentImage} style={{ width: '400px' }} />
                            </p>
                            <p><StepLabel step="step 2/2" />
                                ...
                                <img src={stepMoveSayHello} className={styles.contentImage} style={{ width: '400px' }} />
                            </p>
            ...
            },
            {
                ...
                title: (
                    <div className={styles.contentContainer}>
                        <p className={styles.contentTitle}><TipsLabel />Working with Blocks</p>
                        <ScrollableContainer height='300px'>
                            <p>
                    ...
                    <div className={styles.contentContainer}>
                        ...
                        <ScrollableContainer height='300px'>
                            <p>
                                ...
                                <span className={styles.yellowMark}>50, 100, 140 and 180.</span>
                                Click <CheckButtonImg /> to see whether you use the <b>right value.</b>
                                <img src={coloringTheCat} className={styles.contentImage} style={{ width: '400px' }} />
                            </p>
                        </ScrollableContainer>
                    </div>
                ),
            ...
            },
            {
                ...
                title: (
                    <div className={styles.contentContainer}>
                        ...
                        <ScrollableContainer height='300px'>
                            <p>
                                The program (already created for you) animates cat jumping continuously.<br />
                                <StepLabel step="Inspect First!" />Click <GreenFlagButton /> to see what the jumping animation looks like.
                                We can make a "jump" custom block out of the program part that performs the jumping action. <br />
                            </p>
                            <p>
                                <StepLabel step="Step 1/2" /> First we need to create a jump block.
                                <img src={jump01} className={styles.contentImage} style={{ width: '400px' }} />
                            </p>
                            <p>
                                <StepLabel step="Step 2/2" />
                                With the jump block created, we need to define what it does. We can use the existing program part for that. Finally we can use the created jump block wherever we need in our code.
            ...
            },
            {
                ...
                title: (
                    <div className={styles.contentContainer}>
                        ...
                        <ScrollableContainer height='300px'>
                            <p> We want to make the cat jump with two different heights.<br />
                                The number of repetition affects the jump's height.
                            Luckily, with <b>custom block's parameters</b>, we don't need to create a new jump custom block for every new height we want. Follow the steps below to add a height parameter to the "jump" custom block.
                            </p>
                            <p>
                            ...
                            <div>
                                <p>
                                    ...
                                    Use "height" parameter in the jump block's definition to make the cat jump with a given height.
                                </p>
                                <img src={useParameter} className={styles.contentImage} style={{ width: '150px' }} />
                            </div>
                            <p>
                                <StepLabel step="Step 3/3" />  Modify the program so the cat alternates between
                                ...
                                <img src={useBlockWithParam} className={styles.contentImage} style={{ width: '400px' }} />
                            </p>
                            <p>
